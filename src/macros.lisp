;;;; src/macros.lisp
;;;;
;;;; Shared DEFMACRO infrastructure consumed by every later file. Loaded
;;;; immediately after PACKAGE and before CONDITIONS (which is itself
;;;; generated by DEFINE-DATE-KIT-CONDITION below), so every macro here must
;;;; stand on its own -- no dependency on any value/struct type defined
;;;; later in the :SERIAL T load order.
