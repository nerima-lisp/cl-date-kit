...
(defun month-from-value (value)
  ...
  (if (and (integerp value) (<= 1 value 12))
      (aref *iso-month-names* (1- value))
...
(defun month-length (month leap-year-p)
  ...
  (aref (if leap-year-p *leap-year-month-lengths* *common-year-month-lengths*)
        (%month-index month)))
...
(defun month-first-day-of-year (month leap-year-p)
  ...
  (check-type leap-year-p boolean)
  (aref (if leap-year-p *leap-year-first-days* *common-year-first-days*)
        (%month-index month)))
